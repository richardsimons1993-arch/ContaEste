...
$password = ConvertTo-SecureString -String "S0p0rt3!!2025" -Force -AsPlainText

Write-Host "Re-generando certificado con parmetros extendidos..."
# DNSName is critical for Chrome/Edge to trust it as "Secure"
$cert = New-SelfSignedCertificate -DnsName "localhost", "127.0.0.1" -CertStoreLocation "cert:\LocalMachine\My" -FriendlyName "ContaEste SSL" -NotAfter (Get-Date).AddYears(10) -KeyUsage DigitalSignature, KeyEncipherment -Type SSLServerAuthentication -KeyExportPolicy Exportable
